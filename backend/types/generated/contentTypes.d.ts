...
export interface ApiBeforeAfterBeforeAfter extends Struct.SingleTypeSchema {
  collectionName: 'before_afters';
  info: {
    description: '\u041F\u0430\u0440\u044B \u0444\u043E\u0442\u043E\u0433\u0440\u0430\u0444\u0438\u0439 \u0442\u0435\u0442\u0440\u0430\u0434\u0435\u0439 \u0434\u043E \u0438 \u043F\u043E\u0441\u043B\u0435 \u0437\u0430\u043D\u044F\u0442\u0438\u0439';
    displayName: '\u0424\u043E\u0442\u043E \u0414\u043E / \u041F\u043E\u0441\u043B\u0435';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    pairs: Schema.Attribute.Component<'content.before-after-pair', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiContactInfoContactInfo extends Struct.SingleTypeSchema {
  ...
  info: {
    description: '\u041A\u043D\u043E\u043F\u043A\u0438 \u0441\u0432\u044F\u0437\u0438 \u043D\u0430 \u0441\u0430\u0439\u0442\u0435';
...
export interface ApiProgramProgram extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u041F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u044B \u0437\u0430\u043D\u044F\u0442\u0438\u0439 \u0434\u043B\u044F \u0441\u0430\u0439\u0442\u0430';
    displayName: '\u041F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u0430 \u0437\u0430\u043D\u044F\u0442\u0438\u0439';
    pluralName: 'programs';
  ...
  attributes: {
    backgroundColor: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'#E8E0F5'>;
    color: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#7B5EA7'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    icon: Schema.Attribute.String & Schema.Attribute.DefaultTo<'\u270F\uFE0F'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::program.program'
...
export interface ApiVideoLessonVideoLesson extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u0412\u0438\u0434\u0435\u043E \u0443\u0440\u043E\u043A\u043E\u0432 \u2014 \u0437\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u0435 \u0444\u0430\u0439\u043B \u0438\u043B\u0438 \u0443\u043A\u0430\u0436\u0438\u0442\u0435 \u0441\u0441\u044B\u043B\u043A\u0443 \u043D\u0430 YouTube';
    displayName: '\u0412\u0438\u0434\u0435\u043E \u0441 \u0437\u0430\u043D\u044F\u0442\u0438\u0439';
